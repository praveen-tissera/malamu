	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.1" style="background-color:#11C8DA;">
					<div class="desc aboutus-desc">
						<div class="container">
							<div class="row">
			...
			<div id="fh5co-blog-section" class="fh5co-section-gray">
				<div class="container">
					<div class="row">
						<div class="col-md-12  text-justify heading-section animate-box">
							
							<p class="about-description">
							<span>M</span>alamu is a Canadian tech based company, and a Non-Government Organization that desires to overcome four of the United Nation’s sustainable development goals. Our online platform allows users who are located developing countries the opportunity to earn money. 
							</p>
				...
				<div class="container">
					<div class="row row-bottom-padded-md">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-md-offset-1 animate-box">
							<ul>
								<li> <h4>End Poverty</h4> </li>
								<li> <h4>Advance quality education</h4>  </li>
							</ul>
					
						</div>
						<div class="col-lg-4 col-md-4 col-md-offset-2 col-sm-4 animate-box">
							<ul>
								<li> <h4>Inspire economic growth</h4> </li>
								<li> <h4>Initiate innovation</h4>  </li>
							</ul>
			...
			<div id="fh5co-tours" class="fh5co-features">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 animate-box text-center" data-animate-effect="fadeIn">
							<h1>Our Mission</h1>
							
							<blockquote>
							<h4>Economically empower university students in DRC, through theoptimization of the internet.</h4>
							</blockquote>
							<h1>Our Purpose</h1>
							
							<blockquote>
							<h4>Create economic opportunities for young people who are in undeveloped countries.</h4>
							</blockquote>
						</div>
